...
@TeleOp(name="DemoMore")

public class DemoMore extends OpMode
{
    ...
    private double armEncoderMultiplyer = 2600.0/90.0; //encoder target required for 90 degree turn / 90.0
    ...
    public void loop() {
        ...
        //slowmode for slide. no overide for this one (:
            ...
            */
            ...
            if (slideTarget > 1900 && armTarget > 26 && !slideOverride) { //limit before override
    ...
    //still need to implement armEncoderMultiplyer with /1725, *90 for all
    //these autos.
